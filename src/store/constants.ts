...
export const RESET_VIEW_IN_STORE = 'RESET_VIEW_IN_STORE'
export const SET_VIEW_2D_IN_STORE = 'SET_VIEW_2D_IN_STORE'
export const SET_VIEW_3D_IN_STORE = 'SET_VIEW_3D_IN_STORE'
